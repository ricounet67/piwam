...
<table class="datalist">
  <thead>
    <tr>
      <th >Nom</th>
      <th >Description</th>
      <th width="140px">Nombre de droits</th>
      <th width="140px">Nombre de membres</th>
  ...
  <?php foreach ($aclGroups as $aclGroup): ?>
    <tr>
      ...
      <td><?php echo link_to(image_tag('/pwCorePlugin/images/icons/edit',   
      ...
      array('method' => 'delete', 'confirm' => 'Etes vous sûr ?')) ?></td>
    </tr>
    <?php endforeach ?>
  </tbody>
</table>
