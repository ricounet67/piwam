...
/**
 * Base class that represents a row from the 'piwam_activite' table.
 *
 * 
 *
...
abstract class BaseActivite extends BaseObject  implements Persistent {
	...
	public function setLibelle($v)
	{
		...
		if ($this->libelle !== $v) {
			$this->libelle = $v;
			$this->modifiedColumns[] = ActivitePeer::LIBELLE;
		}
	...
	public function setActif($v)
	{
		...
		if ($this->actif !== $v || $this->isNew()) {
			$this->actif = $v;
			$this->modifiedColumns[] = ActivitePeer::ACTIF;
		}
	...
	public function setAssociationId($v)
	{
		...
		if ($this->association_id !== $v) {
			...
			$this->modifiedColumns[] = ActivitePeer::ASSOCIATION_ID;
		}
	...
	public function setEnregistrePar($v)
	{
		...
		if ($this->enregistre_par !== $v) {
			...
			$this->modifiedColumns[] = ActivitePeer::ENREGISTRE_PAR;
		}
	...
	public function setMisAJourPar($v)
	{
		...
		if ($this->mis_a_jour_par !== $v) {
			...
			$this->modifiedColumns[] = ActivitePeer::MIS_A_JOUR_PAR;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->association_id = ($row[$startcol + 3] !== null) ? (int) $row[$startcol + 3] : null;
			...
			return $startcol + 8; // 8 = ActivitePeer::NUM_COLUMNS - ActivitePeer::NUM_LAZY_LOAD_COLUMNS).
	...
	public function delete(PropelPDO $con = null)
	{
		...
		try {
			...
			foreach (sfMixer::getCallables('BaseActivite:delete:pre') as $callable)
			{
			...
			if ($ret) {
				ActivitePeer::doDelete($this, $con);
				$this->postDelete($con);
				// symfony_behaviors behavior
				foreach (sfMixer::getCallables('BaseActivite:delete:post') as $callable)
				{
	...
	public function save(PropelPDO $con = null)
	{
		...
		try {
			...
			// symfony_behaviors behavior
			foreach (sfMixer::getCallables('BaseActivite:save:pre') as $callable)
			{
			...
			if ($ret) {
				...
				$this->postSave($con);
				// symfony_behaviors behavior
				foreach (sfMixer::getCallables('BaseActivite:save:post') as $callable)
				{
	...
	protected function doSave(PropelPDO $con)
	{
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->isModified()) {
				if ($this->isNew()) {
					$pk = ActivitePeer::doInsert($this, $con);
					...
					$affectedRows += ActivitePeer::doUpdate($this, $con);
				}
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[3], $arr)) $this->setAssociationId($arr[$keys[3]]);
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(ActivitePeer::LIBELLE)) $criteria->add(ActivitePeer::LIBELLE, $this->libelle);
		if ($this->isColumnModified(ActivitePeer::ACTIF)) $criteria->add(ActivitePeer::ACTIF, $this->actif);
		if ($this->isColumnModified(ActivitePeer::ASSOCIATION_ID)) $criteria->add(ActivitePeer::ASSOCIATION_ID, $this->association_id);
		if ($this->isColumnModified(ActivitePeer::ENREGISTRE_PAR)) $criteria->add(ActivitePeer::ENREGISTRE_PAR, $this->enregistre_par);
		if ($this->isColumnModified(ActivitePeer::MIS_A_JOUR_PAR)) $criteria->add(ActivitePeer::MIS_A_JOUR_PAR, $this->mis_a_jour_par);
	...
	public function getAssociation(PropelPDO $con = null)
	{
		if ($this->aAssociation === null && ($this->association_id !== null)) {
			...
			/* The following can be used additionally to
			   ...
			   $this->aAssociation->addActivites($this);
			 */
		}
	...
	public function setMembreRelatedByEnregistrePar(Membre $v = null)
	{
		...
		if ($v !== null) {
			$v->addActiviteRelatedByEnregistrePar($this);
		}
	...
	public function getMembreRelatedByEnregistrePar(PropelPDO $con = null)
	{
		if ($this->aMembreRelatedByEnregistrePar === null && ($this->enregistre_par !== null)) {
			...
			/* The following can be used additionally to
			   ...
			   undesirable since it could result in an only partially populated collection
			   in the referenced object.
			   $this->aMembreRelatedByEnregistrePar->addActivitesRelatedByEnregistrePar($this);
			 */
		}
	...
	public function setMembreRelatedByMisAJourPar(Membre $v = null)
	{
		...
		// If this object has already been added to the Membre object, it will not be re-added.
		if ($v !== null) {
			$v->addActiviteRelatedByMisAJourPar($this);
		}
	...
	public function getMembreRelatedByMisAJourPar(PropelPDO $con = null)
	{
		if ($this->aMembreRelatedByMisAJourPar === null && ($this->mis_a_jour_par !== null)) {
			...
			/* The following can be used additionally to
			   ...
			   undesirable since it could result in an only partially populated collection
			   in the referenced object.
			   $this->aMembreRelatedByMisAJourPar->addActivitesRelatedByMisAJourPar($this);
			 */
		}
	 ...
	 * Otherwise if this Activite has previously been saved, it will retrieve
	 * related Depenses from storage. If this Activite is new, it will return
		...
		if ($this->collDepenses === null) {
			if ($this->isNew()) {
			   $this->collDepenses = array();
				...
				$criteria->add(DepensePeer::ACTIVITE_ID, $this->id);
	 ...
	 * If this collection has already been initialized with an identical Criteria, it returns the collection.
	 * Otherwise if this Activite has previously been saved, it will retrieve
	 * related Recettes from storage. If this Activite is new, it will return
	 * an empty collection or the current collection, the criteria is ignored on a new object.
	 *
	 * @param      PropelPDO $con
	 * @param      Criteria $criteria
		...
		if ($this->collRecettes === null) {
			if ($this->isNew()) {
			   $this->collRecettes = array();
				...
				$criteria->add(RecettePeer::ACTIVITE_ID, $this->id);
	...
	{
	  if (!$callable = sfMixer::getCallable('BaseActivite:'.$method))
	  {
	    throw new sfException(sprintf('Call to undefined method BaseActivite::%s', $method));
	  }
