...
abstract class BaseMembre extends BaseObject  implements Persistent {
  ...
  const PEER = 'MembrePeer';
	...
	public function getDateinscription($format = 'Y-m-d')
	{
		...
		if ($this->dateinscription === '0000-00-00') {
	...
	public function setDateinscription($v)
	{
		...
		if ( $this->dateinscription !== null || $dt !== null ) {
			...
			$currNorm = ($this->dateinscription !== null && $tmpDt = new DateTime($this->dateinscription)) ? $tmpDt->format('Y-m-d') : null;
			$newNorm = ($dt !== null) ? $dt->format('Y-m-d') : null;

			if ( ($currNorm !== $newNorm) // normalized values don't match 
					)
			{
				$this->dateinscription = ($dt ? $dt->format('Y-m-d') : null);
