...
/**
 * This class adds structure of 'piwam_acl_action' table to 'propel' DatabaseMap object.
 *
 *
...
class AclActionMapBuilder implements MapBuilder {
	...
	public function doBuild()
	{
		...
		$tMap->addForeignKey('ACL_MODULE_ID', 'AclModuleId', 'INTEGER', 'piwam_acl_module', 'ID', true, null);
