...
<table class="formArray">
    <tfoot>
        <tr>
            <td colspan="2"><?php echo $form->renderHiddenFields() ?> <?php echo link_to('Annuler', 'compte/index', array(
            	'class'	=> 'formLinkButton'
            	)) ?> <?php if (!$form->getObject()->isNew()): ?> <?php echo link_to('Supprimer', 'compte/delete?id='.$form->getObject()->getId(), array('method' => 'delete', 'confirm' => 'Ètes vous sûr ?', 'class' => 'formLinkButton')) ?>
    ...
    <?php echo $form->renderGlobalErrors() ?>
        ...
        <tr>
            <th>Référence</th>
            <td><?php echo $form['reference'] ?> <?php echo $form['reference']->renderError() ?>
