...
abstract class BaseMembre extends BaseObject  implements Persistent {
  ...
  const PEER = 'MembrePeer';
	...
	/**
	 * The value for the exemptecotis field.
	 * @var        boolean
	 */
	protected $exemptecotis;
	...
	/**
	 * The value for the telfixe field.
	 * @var        string
	 */
	protected $telfixe;

	/**
	 * The value for the telportable field.
	 * @var        string
	 */
	 ...
	 */
	public function getDateinscription($format = 'Y-m-d H:i:s')
	{
		...
		if ($this->dateinscription === '0000-00-00 00:00:00') {
			// while technically this is not a default value of NULL,
			// this seems to be closest in meaning.
			return null;
		} else {
			try {
				$dt = new DateTime($this->dateinscription);
			} catch (Exception $x) {
				throw new PropelException("Internally stored date/time/timestamp value could not be converted to DateTime: " . var_export($this->dateinscription, true), $x);
			}
		}
	...
	/**
	 * Get the [exemptecotis] column value.
	 * 
	 * @return     boolean
	 */
	public function getExemptecotis()
	{
		return $this->exemptecotis;
	}
	...
	/**
	 * Get the [telportable] column value.
	 * 
	 * @return     string
	 */
	...
	public function setDateinscription($v)
	{
		...
		if ( $this->dateinscription !== null || $dt !== null ) {
			...
			$currNorm = ($this->dateinscription !== null && $tmpDt = new DateTime($this->dateinscription)) ? $tmpDt->format('Y-m-d H:i:s') : null;
			$newNorm = ($dt !== null) ? $dt->format('Y-m-d H:i:s') : null;

			if ( ($currNorm !== $newNorm) // normalized values don't match 
					)
			{
				$this->dateinscription = ($dt ? $dt->format('Y-m-d H:i:s') : null);
				$this->modifiedColumns[] = MembrePeer::DATEINSCRIPTION;
			}
	...
	/**
	 * Set the value of [exemptecotis] column.
	 * 
	 * @param      boolean $v new value
	 * @return     Membre The current object (for fluent API support)
	 */
	public function setExemptecotis($v)
	{
		if ($v !== null) {
			$v = (boolean) $v;
		}

		if ($this->exemptecotis !== $v) {
			$this->exemptecotis = $v;
			$this->modifiedColumns[] = MembrePeer::EXEMPTECOTIS;
		}
	...
	/**
	 * Set the value of [telfixe] column.
	 * 
	 * @param      string $v new value
	 * @return     Membre The current object (for fluent API support)
	 */
	public function setTelfixe($v)
	{
		...
		if ($this->telfixe !== $v) {
			$this->telfixe = $v;
			$this->modifiedColumns[] = MembrePeer::TELFIXE;
		}
	...
	/**
	 * Set the value of [telportable] column.
	 * 
	 * @param      string $v new value
	 * @return     Membre The current object (for fluent API support)
	 */
	public function setTelportable($v)
	{
		...
		if ($this->telportable !== $v) {
			$this->telportable = $v;
			$this->modifiedColumns[] = MembrePeer::TELPORTABLE;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->dateinscription = ($row[$startcol + 6] !== null) ? (string) $row[$startcol + 6] : null;
			$this->exemptecotis = ($row[$startcol + 7] !== null) ? (boolean) $row[$startcol + 7] : null;
			...
			$this->telfixe = ($row[$startcol + 14] !== null) ? (string) $row[$startcol + 14] : null;
			$this->telportable = ($row[$startcol + 15] !== null) ? (string) $row[$startcol + 15] : null;
			...
			return $startcol + 19; // 19 = MembrePeer::NUM_COLUMNS - MembrePeer::NUM_LAZY_LOAD_COLUMNS).
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[7], $arr)) $this->setExemptecotis($arr[$keys[7]]);
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(MembrePeer::DATEINSCRIPTION)) $criteria->add(MembrePeer::DATEINSCRIPTION, $this->dateinscription);
		if ($this->isColumnModified(MembrePeer::EXEMPTECOTIS)) $criteria->add(MembrePeer::EXEMPTECOTIS, $this->exemptecotis);
		...
		if ($this->isColumnModified(MembrePeer::TELFIXE)) $criteria->add(MembrePeer::TELFIXE, $this->telfixe);
		if ($this->isColumnModified(MembrePeer::TELPORTABLE)) $criteria->add(MembrePeer::TELPORTABLE, $this->telportable);
	...
	public function copyInto($copyObj, $deepCopy = false)
	{
		...
		$copyObj->setDateinscription($this->dateinscription);

		$copyObj->setExemptecotis($this->exemptecotis);
		...
		$copyObj->setTelfixe($this->telfixe);

		$copyObj->setTelportable($this->telportable);
